...
static const char *PDB2POV_USAGE =
    ...
    "    --keep-altlocs\n"
    "                keep every alternate conformation (default: keep only\n"
    "                the blank and 'A' indicators)\n"
    "    --legacy-elements\n"
    "                guess elements from atom names instead of reading the\n"
    "                PDB element column.  Restores pre-2.1 behaviour, in\n"
    "                which NA reads as nitrogen and CL as carbon.\n"
    "\n"
